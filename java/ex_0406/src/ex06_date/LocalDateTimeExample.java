...
public class LocalDateTimeExample {
	public static void main(String[] args) {
		...
		// isbefore() : 앞선 시간인지 비교
		// isAfter() : 뒤의 시간인지 비교
		LocalDateTime meating = LocalDateTime.of(2026, 4, 10, 14, 0);
		
		System.out.println(now.isBefore(meating));
		System.out.println(now.isAfter(meating));
		System.out.println(now.isEqual(meating));
		...
		LocalDateTime start  = now.withHour(9).withMonth(0).withSecond(0);
		LocalDateTime end  = now.withHour(18).of(2026, 4, 6 ,18, 0);
