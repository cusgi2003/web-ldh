...
public class FunctionExample {
	public static void main(String[] args) {
		...
		Function<String, String> trimSpace = str -> str.replace(" ", "");
		Function<String, String> tolower = str -> str.toLowerCase();
		Function<String, String> strPlus = str -> "user_" + str;
		
		Function<String,String> pipeline = trimSpace.
				andThen(tolower).andThen(strPlus);
