...
public class BuffereedReaderExample2 {
	public static void main(String[] args) {
		...
		// 보조스트림이기 때문에 기반 스트림이 필요하다
		
		// System.in : 표준 입력 스트림(바이트 기반 스트림)
		// 문자나 문자열을 편하게 읽는 용도가 아니라 바이트단위로 데이터를 읽는 통로
		// 그래서 InputStreanReader를 사용해서 문자 스트림으로 변환해준다.
