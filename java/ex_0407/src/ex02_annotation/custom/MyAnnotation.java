package ex02_annotation.custom;
...
// @Target : 어디에 붙일 수 있는 정하는 것
// 타겟대상 : ElementType 열거형 값을 넣는다.
// ElementType.TYPE : 클래스, 인터페이스, enum 등에 붙일 수 있다
// 메서드는 안됨
...
// @Retuention : 어노테이션 정보를 언제까지 유지할 것인지 정한다
// SOURCE : 소스 코드에만 남기고 컴파일 후 사라진다
// CLASS : 클래스파일에는 남지만 실행 중에는 못읽는다
