...
public class Chef {
// 의존성
// 어떤 클래스가 다른 클래스의 기능을 사용해야할 때, "의존 관계가 생겼다"라고 한다
...
// 요리사는 칼이 필요하다 -> 요리사는 칼에 의존성이 있다.
	...
	// 필드 주입
	// 멤버 변수(필드)에 직접 객체(의존성)을 주입하는 방식
	// 객첼르 생ㅅ어할 때 어떤 의존성이 필요한지 한 눈에 알아보기 어렵다
	// 단위테스트가 어렵고 현재 권장하지 않는 방식이다.
